...
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$UjJqpWtSRytmDEZ36GvXAA$GtMTi0Gj7mh8GqMq48M9+w'
...
#  Choices: any of ['sha512', 'sha3_256', 'blake2s', 'sha3_512', 'blake2b', 'sha256', 'sha3_224', 'sha3_384', 'sha1', 'md5', 'sha224', 'sha384']
#  Default: 'sha256'
