...
def defFactor(fdi: FactorDefInput, dep_fd: Dict[str, FactorDef]) -> FactorDef:
    ...
    Cost_TTM = where(Cost_TTM, notnull(Cost_TTM), FT.getFactor("营业成本"))
    OpNetProfit_TTM = where(OpNetProfit_TTM, notnull(OpNetProfit_TTM), FT.getFactor("营业利润"))
    SalesExpenses_TTM = where(SalesExpenses_TTM, notnull(SalesExpenses_TTM), FT.getFactor("销售费用"))
    ManagementExpenses_TTM = where(ManagementExpenses_TTM, notnull(ManagementExpenses_TTM), FT.getFactor("管理费用"))
    FinancialExpenses_TTM = where(FinancialExpenses_TTM, notnull(FinancialExpenses_TTM), FT.getFactor("财务费用"))
    FT = JYDB.getTable("科创板利润分配表", args={"CalcType": "TTM", "ReportDate": "所有", "YearLookBack": 1})
    NetProfit_TTM_L1 = where(NetProfit_TTM_L1, notnull(NetProfit_TTM_L1), FT.getFactor("归属于母公司所有者的净利润"))
    Sales_L1 = where(Sales_L1, notnull(Sales_L1), FT.getFactor("营业收入"))
    Cost_L1 = where(Cost_L1, notnull(Cost_L1), FT.getFactor("营业成本"))
    FT = JYDB.getTable("科创板利润分配表", args={"CalcType": "TTM", "ReportDate": "所有", "YearLookBack": 2})
    NetProfit_TTM_L2 = where(NetProfit_TTM_L2, notnull(NetProfit_TTM_L2), FT.getFactor("归属于母公司所有者的净利润"))
    Sales_L2 = where(Sales_L2, notnull(Sales_L2), FT.getFactor("营业收入"))
    Cost_L2 = where(Cost_L2, notnull(Cost_L2), FT.getFactor("营业成本"))
    FT = JYDB.getTable("科创板利润分配表", args={"CalcType": "TTM", "ReportDate": "所有", "YearLookBack": 3})
    NetProfit_TTM_L3 = where(NetProfit_TTM_L3, notnull(NetProfit_TTM_L3), FT.getFactor("归属于母公司所有者的净利润"))
    Sales_L3 = where(Sales_L3, notnull(Sales_L3), FT.getFactor("营业收入"))
    Cost_L3 = where(Cost_L3, notnull(Cost_L3), FT.getFactor("营业成本"))
    FT = JYDB.getTable("科创板利润分配表", args={"CalcType": "TTM", "ReportDate": "所有", "YearLookBack": 4})
    NetProfit_TTM_L4 = where(NetProfit_TTM_L4, notnull(NetProfit_TTM_L4), FT.getFactor("归属于母公司所有者的净利润"))
    Sales_L4 = where(Sales_L4, notnull(Sales_L4), FT.getFactor("营业收入"))
    Cost_L4 = where(Cost_L4, notnull(Cost_L4), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ0P = where(Non_Inc_SQ0P, notnull(Non_Inc_SQ0P), FT.getFactor("加-营业外收入"))
    Sales_SQ0P = where(Sales_SQ0P, notnull(Sales_SQ0P), FT.getFactor("营业收入"))
    Cost_SQ0P = where(Cost_SQ0P, notnull(Cost_SQ0P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ1P = where(Non_Inc_SQ1P, notnull(Non_Inc_SQ1P), FT.getFactor("加-营业外收入"))
    Sales_SQ1P = where(Sales_SQ1P, notnull(Sales_SQ1P), FT.getFactor("营业收入"))
    Cost_SQ1P = where(Cost_SQ1P, notnull(Cost_SQ1P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ2P = where(Non_Inc_SQ2P, notnull(Non_Inc_SQ2P), FT.getFactor("加-营业外收入"))
    Sales_SQ2P = where(Sales_SQ2P, notnull(Sales_SQ2P), FT.getFactor("营业收入"))
    Cost_SQ2P = where(Cost_SQ2P, notnull(Cost_SQ2P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ3P = where(Non_Inc_SQ3P, notnull(Non_Inc_SQ3P), FT.getFactor("加-营业外收入"))
    Sales_SQ3P = where(Sales_SQ3P, notnull(Sales_SQ3P), FT.getFactor("营业收入"))
    Cost_SQ3P = where(Cost_SQ3P, notnull(Cost_SQ3P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ4P = where(Non_Inc_SQ4P, notnull(Non_Inc_SQ4P), FT.getFactor("加-营业外收入"))
    Sales_SQ4P = where(Sales_SQ4P, notnull(Sales_SQ4P), FT.getFactor("营业收入"))
    Cost_SQ4P = where(Cost_SQ4P, notnull(Cost_SQ4P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ5P = where(Non_Inc_SQ5P, notnull(Non_Inc_SQ5P), FT.getFactor("加-营业外收入"))
    Sales_SQ5P = where(Sales_SQ5P, notnull(Sales_SQ5P), FT.getFactor("营业收入"))
    Cost_SQ5P = where(Cost_SQ5P, notnull(Cost_SQ5P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ6P = where(Non_Inc_SQ6P, notnull(Non_Inc_SQ6P), FT.getFactor("加-营业外收入"))
    Sales_SQ6P = where(Sales_SQ6P, notnull(Sales_SQ6P), FT.getFactor("营业收入"))
    Cost_SQ6P = where(Cost_SQ6P, notnull(Cost_SQ6P), FT.getFactor("营业成本"))
    ...
    Non_Inc_SQ7P = where(Non_Inc_SQ7P, notnull(Non_Inc_SQ7P), FT.getFactor("加-营业外收入"))
    Sales_SQ7P = where(Sales_SQ7P, notnull(Sales_SQ7P), FT.getFactor("营业收入"))
    Cost_SQ7P = where(Cost_SQ7P, notnull(Cost_SQ7P), FT.getFactor("营业成本"))
    ...
    CurDebt = where(CurDebt, notnull(CurDebt), FT.getFactor("流动负债合计"))
    CurAsset = where(CurAsset, notnull(CurAsset), FT.getFactor("流动资产合计"))
    FixAsset = where(FixAsset, notnull(FixAsset), FT.getFactor("固定资产合计"))
    Asset = where(Asset, notnull(Asset), FT.getFactor("资产总计"))
    Equity = where(Equity, notnull(Equity), FT.getFactor("归属母公司股东权益合计"))
    AR = where(AR, notnull(AR), FT.getFactor("应收账款"))
    Debt = where(Debt, notnull(Debt), FT.getFactor("负债合计"))
    LTDebt = where(LTDebt, notnull(LTDebt), FT.getFactor("非流动负债合计"))
    Inventory = where(Inventory, notnull(Inventory), FT.getFactor("存货"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "最新", "ReportDate": "所有", "YearLookBack": 1})
    CurDebt_L1 = where(CurDebt_L1, notnull(CurDebt_L1), FT.getFactor("流动负债合计"))
    CurAsset_L1 = where(CurAsset_L1, notnull(CurAsset_L1), FT.getFactor("流动资产合计"))
    FixAsset_L1 = where(FixAsset_L1, notnull(FixAsset_L1), FT.getFactor("固定资产合计"))
    ...
    AR_L1 = where(AR_L1, notnull(AR_L1), FT.getFactor("应收账款"))
    Debt_L1 = where(Debt_L1, notnull(Debt_L1), FT.getFactor("负债合计"))
    LTDebt_L1 = where(LTDebt_L1, notnull(LTDebt_L1), FT.getFactor("非流动负债合计"))
    Inventory_L1 = where(Inventory_L1, notnull(Inventory_L1), FT.getFactor("存货"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "最新", "ReportDate": "所有", "YearLookBack": 2})
    Asset_L2 = where(Asset_L2, notnull(Asset_L2), FT.getFactor("资产总计"))
    Equity_L2 = where(Equity_L2, notnull(Equity_L2), FT.getFactor("归属母公司股东权益合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "最新", "ReportDate": "所有", "YearLookBack": 3})
    Asset_L3 = where(Asset_L3, notnull(Asset_L3), FT.getFactor("资产总计"))
    Equity_L3 = where(Equity_L3, notnull(Equity_L3), FT.getFactor("归属母公司股东权益合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "最新", "ReportDate": "所有", "YearLookBack": 4})
    Asset_L4 = where(Asset_L4, notnull(Asset_L4), FT.getFactor("资产总计"))
    Equity_L4 = where(Equity_L4, notnull(Equity_L4), FT.getFactor("归属母公司股东权益合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "最新", "ReportDate": "所有", "YearLookBack": 5})
    Asset_L5 = where(Asset_L5, notnull(Asset_L5), FT.getFactor("资产总计"))
    Equity_L5 = where(Equity_L5, notnull(Equity_L5), FT.getFactor("归属母公司股东权益合计"))
    ...
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 0})
    Empl_Pay_SQ0P = where(Empl_Pay_SQ0P, notnull(Empl_Pay_SQ0P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ0P = where(FixAsset_SQ0P, notnull(FixAsset_SQ0P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 1})
    Empl_Pay_SQ1P = where(Empl_Pay_SQ1P, notnull(Empl_Pay_SQ1P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ1P = where(FixAsset_SQ1P, notnull(FixAsset_SQ1P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 2})
    Empl_Pay_SQ2P = where(Empl_Pay_SQ2P, notnull(Empl_Pay_SQ2P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ2P = where(FixAsset_SQ2P, notnull(FixAsset_SQ2P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 3})
    Empl_Pay_SQ3P = where(Empl_Pay_SQ3P, notnull(Empl_Pay_SQ3P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ3P = where(FixAsset_SQ3P, notnull(FixAsset_SQ3P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 4})
    Empl_Pay_SQ4P = where(Empl_Pay_SQ4P, notnull(Empl_Pay_SQ4P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ4P = where(FixAsset_SQ4P, notnull(FixAsset_SQ4P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 5})
    Empl_Pay_SQ5P = where(Empl_Pay_SQ5P, notnull(Empl_Pay_SQ5P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ5P = where(FixAsset_SQ5P, notnull(FixAsset_SQ5P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 6})
    Empl_Pay_SQ6P = where(Empl_Pay_SQ6P, notnull(Empl_Pay_SQ6P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ6P = where(FixAsset_SQ6P, notnull(FixAsset_SQ6P), FT.getFactor("固定资产合计"))
    FT = JYDB.getTable("科创板资产负债表", args={"CalcType": "单季度", "ReportDate": "所有", "PeriodLookBack": 7})
    Empl_Pay_SQ7P = where(Empl_Pay_SQ7P, notnull(Empl_Pay_SQ7P), FT.getFactor("应付职工薪酬"))
    FixAsset_SQ7P = where(FixAsset_SQ7P, notnull(FixAsset_SQ7P), FT.getFactor("固定资产合计"))
    ...
    FT = JYDB.getTable("科创板衍生报表数据", args={"CalcType": "最新", "ReportDate": "所有"})
    CurDebt_NonInterset = where(CurDebt_NonInterset, notnull(CurDebt_NonInterset), FT.getFactor("无息流动负债"))
    NonCurDebt_NonInterset = where(NonCurDebt_NonInterset, notnull(NonCurDebt_NonInterset), FT.getFactor("无息非流动负债"))
    ...
    RetainedEarnings_TTM = where(RetainedEarnings_TTM, notnull(RetainedEarnings_TTM), FT.getFactor("留存收益"))
    ...
    TotalStock = where(TotalStock, notnull(TotalStock), FT.getFactor("总股本(股)"))
    FT = JYDB.getTable("科创板报告期主要会计数据", args={"CalcType": "最新", "ReportDate": "所有", "YearLookBack": 1})
    TotalStock_L1 = where(TotalStock_L1, notnull(TotalStock_L1), FT.getFactor("总股本(股)"))
    ...
    Capex_TTM = where(Capex_TTM, notnull(Capex_TTM), FT.getFactor("购建固定资产、无形资产和其他长期资产支付的现金"))
