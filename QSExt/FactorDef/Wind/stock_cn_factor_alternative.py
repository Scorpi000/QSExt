...
def defFactor(args={}):
    ...
    # 收盘价和换手率的相关性
    Turnover_Close_5D_Corr = QS.FactorDB.TimeOperation("Turnover_Close_5D_Corr", [Turnover, AdjClose, TradeStatus], sys_args={"算子": Cls_Trun_Correl_Fun, '参数':{"非空率":0.8},"回溯期数": [5-1,5-1,5-1],"运算ID":"多ID"})
    Turnover_Close_20D_Corr = QS.FactorDB.TimeOperation("Turnover_Close_20D_Corr", [Turnover, AdjClose, TradeStatus], sys_args={"算子": Cls_Trun_Correl_Fun, '参数':{"非空率":0.8},"回溯期数": [20-1,20-1,20-1],"运算ID":"多ID"})
    Turnover_Close_60D_Corr = QS.FactorDB.TimeOperation("Turnover_Close_60D_Corr", [Turnover, AdjClose, TradeStatus], sys_args={"算子": Cls_Trun_Correl_Fun, '参数':{"非空率":0.8},"回溯期数": [60-1,60-1,60-1],"运算ID":"多ID"})
    ...
    # 过去一段时间最高价/最低价比值
    High2Low_5D = QS.FactorDB.TimeOperation("High2Low_5D", [Low, High, TradeStatus], sys_args={"算子": HL_Fun,'参数':{"非空率":0.8}, "回溯期数": [5-1,5-1,5-1],"运算ID":"多ID"})
    High2Low_20D = QS.FactorDB.TimeOperation("High2Low_20D", [Low, High, TradeStatus], sys_args={"算子": HL_Fun,'参数':{"非空率":0.8}, "回溯期数": [20-1,20-1,20-1],"运算ID":"多ID"})
    High2Low_60D = QS.FactorDB.TimeOperation("High2Low_60D", [Low, High, TradeStatus], sys_args={"算子": HL_Fun,'参数':{"非空率":0.8}, "回溯期数": [60-1,60-1,60-1],"运算ID":"多ID"})
