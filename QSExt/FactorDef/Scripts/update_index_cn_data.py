...
def main(
    ...
    with pd.ExcelFile("../conf/config.xlsx", engine="openpyxl") as xlsFile:
        IDs = SectionIDs = sorted(pd.read_excel(xlsFile, "常用指数", index_col=0, header=0).index)
    ...
    ModuleList = [
        (index_cn_info, {}, None),
        (index_cn_day_bar, {}, None),
        (index_cn_stock_component, {}, None),
        (index_cn_factor_value, {}, None),
        (index_cn_factor_from_constituent, ModelArgs | {"component_factor_table": "stock_cn_factor_value", "target_table": "index_cn_factor_value_from_constituent"}, None),
        (index_cn_factor_from_constituent, ModelArgs | {"component_factor_table": "stock_cn_factor_growth", "target_table": "index_cn_factor_growth_from_constituent"}, None),
    ]
